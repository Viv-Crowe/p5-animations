...
var Renderer = (function () {
    ...
    */
    ...
    function Renderer (canvas, wgl, gridDimensions, onLoaded) {
        ...
        // Colour palette — set from outside (e.g. FluidSurface) after construction
    ...
    Renderer.prototype.draw = function (simulator, projectionMatrix, viewMatrix) {
        ...
        if (this.paletteTexture) {
            compositeDrawState
                .uniformTexture('u_palette', 3, wgl.TEXTURE_2D, this.paletteTexture)
                .uniform1f('u_paletteSize', this.paletteSize);
        } else {
            compositeDrawState.uniform1f('u_paletteSize', 0.0);
        }
